...
namespace SmartHouse
{
    ...
    { 
        private const int MAXchannel = 60; // максимальный номер канала, т.е всего можно смотреть 60 каналов
        ...
        public void ChannelScan()
        {
            if (Status)
            {
                ...
                for (int i = 1; i <= MAXchannel; i++)
                {
                    ...
                    Console.WriteLine("Настраивается" + i + "канал...частота - " + frequency + "MHz");  // имитация процесса
        ...
        public void ListChannel()
        {
            if (Status)
            {
                ...
                {
                    Console.WriteLine("№{0} - {1}", i + 1, channels[i]);
                }
                Console.ReadKey();
            }
            else
